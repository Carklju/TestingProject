 ...
 * @author Aleksa
 */
public class TestSignUpFailed2 extends BaseClass{
    ...
    public void executeTest() throws InterruptedException{
        ...
        reg.enterFirstAndLastName("Aleksa");
        reg.enterEmailAdress("asd");
        ...
        reg.enterPassword("aa");   
        reg.clickSignUpButton();
        reg.assertPageEmailAddressNotValid();
        reg.assertPagePasswordPasswordWeak();
    }
