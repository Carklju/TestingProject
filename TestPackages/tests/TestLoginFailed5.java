 ...
 * @author Aleksa
 */
public class TestLoginFailed5 extends BaseClass{
    ...
    public void executeTest() throws InterruptedException{
       ...
       log.enterPassword("");
       log.clickSignInButton();
       new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//body[1]/div[11]/div[1]/div[2]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/div[1]/div[1]")));
       log.assertPagePasswordRequired();
    }
